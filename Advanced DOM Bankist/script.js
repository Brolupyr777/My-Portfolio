...
const imgObserver = new IntersectionObserver(loadImg, {
  // Want to make the blur effect visible
  root: null,
  threshold: 0.5,
  // rootMargin: "200px",
});
...
document.documentElement.style.setProperty("--color-primary", "#07edd6");
...
// h1.closest(".h1").style.textColor = "var(--gradient-secondary)";
